...
<div class="row">
	...
	<div class="col-xs-12 col-md-12">
		<div class="alert alert-warning alert-dismissible" role="alert">
		  ...
		  <strong>Figyelem!</strong> Amennyiben az admin jóváhagyja a kérelmed, az automatikusan átíródik, így neked már nincs több dolgod vele. Kérjük ügyelj, hogy minden adatot a valóságnak megfelelően tölts ki. Amennyiben online voltál az elfogadáskor, kérd meg az admint, hogy írja át neked a szerveren (ha újracsatlakozol, akkor már az új neved lesz, de ha nem szeretnéd ezt megtenni akkor keresd az admint!)! Ügyelj arra, hogy az indoklásod pontos legyen és részletes is, hiszen az admin ez alapján dönti el, hogy elfogadja vagy sem.
		</div>
	
		<form class="form-horizontal col-sm-offset-2" method="POST">
 		  <div class="form-group">
			<label for="newpw" class="col-sm-3 control-label">Új neved</label>
			<div class="col-sm-6">
			  <input type="text" class="form-control" name="new_name" placeholder="Új neved">
			</div>
		  </div> 		 
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-6">
			  <textarea style="resize:none" class="form-control" name="reason" rows="4" placeholder="Ide írd le miért akarsz karakter nevet cserélni..."></textarea>
			</div>
		  </div>		  
		  
		  <div class="form-group">
			<div class="col-sm-offset-3 col-sm-6">
			  <input type="submit" class="form-control btn-success" value="Elküldés" name="name_change_btn">
			</div>
		  </div>
		   <?php
