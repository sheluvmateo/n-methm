...
<!-- Mirrored from sangame.best/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Aug 2018 03:01:26 GMT -->
...
<head>
		...
		<meta name="keywords" content="Sanmta, San mta, v3, lv, las venturas, bone county, roleplay, rp, rpg, Sanmtalv, Sanlv, multi theft auto, Multi Theft Auto, grand theft auto, Grand Theft Auto, San Andreas stories, san andreas stories, mta, cnr, cops and robbers, clan war, clan wars">
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta property="fb:app_id" content="757511084286070"/>
		<meta property="og:url" content="http://sangame.best/" />
		<meta property="og:title" content="SanMTA v3 | sangame.best" />
		<meta property="og:image" content="Assets/Images/bg2.html" />

		<title>SanMTA v3  | sangame.best</title>
...
p {text-align: center;}
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="http://ucp.sangame.best/"><img src="Assets/Images/logo.png" style="max-height: 125%; margin-top: -5px; display: inline; margin: 0 10px;"/>San<font color="#7cc576">MTA v3</font> <font color="#e0bb6a"></font> <font color="lightgrey"> -   User Control Panel</font></a>
				</div>
	...
	<div class="row">
    <h1>Válaszd ki a megfelelőt:</h1>
    <hr>
    <form action="http://ucp.sangame.best/lostusername">
    <input type='submit' class='form-control btn-primary' value='Elfelejtettem a felhasználónevemet' name='felhasznalonev'>
    </form>
    <hr>
    <form action="http://ucp.sangame.best/lostpassword">
    <input type='submit' class='form-control btn-primary' value='Elfelejtettem a jelszavamat' name='jelszo'>
    </form>
    <hr>
